...
class AutomationPlan(models.Model):
    ...
    uu_id = models.UUIDField(unique=True, default=uuid.uuid4)
    ...
    project_uuid = models.CharField(max_length=100) # uuid of the project for the plan
