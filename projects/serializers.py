...
class ProjectDataSerializers(serializers.Serializer):
    ...
    project_disc = serializers.CharField(required=False, help_text="Project Description")
    ## added by me for the cli purpose
    group_name = serializers.CharField(required=False, help_text="Group Name")
